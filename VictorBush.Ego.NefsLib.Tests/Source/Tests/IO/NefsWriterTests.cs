...
namespace VictorBush.Ego.NefsLib.Tests.NefsLib.IO
{
    ...
    public class NefsWriterTests
    {
        ...
        public async Task WriteHeaderPart1Async_ValidData_Written()
        {
            ...
            var file1 = TestHelpers.CreateItem(0, 0, "file1", 10, 11, new List<UInt32> { 12, 13 });
            var file2 = TestHelpers.CreateItem(1, 1, "file2", 20, 21, new List<UInt32> { 22, 23 });
            var dir1 = TestHelpers.CreateItem(2, 2, "dir1", 0, 0, new List<UInt32> { 0 }, isDirectory: true);
            items.Add(file1);
            items.Add(file2);
            items.Add(dir1);
        ...
        public async Task WriteHeaderPart2Async_ValidData_Written()
        {
            ...
            var file2 = TestHelpers.CreateItem(1, 1, "file2", 20, 21, new List<UInt32> { 22, 23 });
            var dir1 = TestHelpers.CreateItem(2, 2, "dir1", 0, 0, new List<UInt32> { 0 }, isDirectory: true);
            var file3 = TestHelpers.CreateItem(3, 2, "file3", 30, 31, new List<UInt32> { 32, 33 });
            items.Add(file1);
            items.Add(file2);
            items.Add(dir1);
            items.Add(file3);
